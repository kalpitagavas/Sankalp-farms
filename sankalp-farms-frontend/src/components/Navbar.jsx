      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <Link to="/" className="group flex items-center gap-3">
            <img src={logoImg} alt="Sankalp Logo" className="h-10 w-10 object-contain group-hover:rotate-12 transition-transform" />
        ...
        <div className="flex items-center justify-end gap-3 md:gap-5 flex-1">
            ...
            {userInfo ? (
              <div className="flex items-center gap-4">
                ...
                <button 
                  ...
                  className="text-[9px] font-black uppercase tracking-widest text-orange-600 hover:text-orange-800 transition-colors"
                >
                  {t('nav.logout') || 'Logout'}
                </button>
              </div>
          ...
          >
            ...
            {totalItem > 0 && (
              <span className="absolute -top-1.5 -right-1.5 bg-orange-500 text-white text-[10px] min-w-[20px] h-5 rounded-full flex items-center justify-center font-black border-2 border-white">
                {totalItem}
              </span>
            )}
          </button>
